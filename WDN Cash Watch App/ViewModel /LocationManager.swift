...
class LocationManager: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    private let countryToCurrency: [String: String] = [
        "BR": "BRL", "US": "USD", "EU": "EUR", "GB": "GBP", "JP": "JPY",
    ...
    override init() {
        ...
        // 🔋 precisão ideal para país (economia de bateria)
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        // 🔥 DESLIGA GPS — economia real de bateria
        ...
        geocoder.reverseGeocodeLocation(location) { placemarks, error in
            DispatchQueue.main.async {
                if let _ = error {
                    ...
                    self.locationError = "Erro ao identificar país."
                    return
                }
                ...
                if let placemark = placemarks?.first,
                   let countryCode = placemark.isoCountryCode {
                    ...
                    self.currencyCode = self.countryToCurrency[countryCode] ?? "BRL"
